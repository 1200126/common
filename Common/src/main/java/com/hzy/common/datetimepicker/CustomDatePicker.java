...
public class CustomDatePicker {
    ...
    private TextView tv_cancle, tv_select, hour_text, minute_text,day_text, month_text,year_text;
    ...
    public CustomDatePicker(Context context, ResultHandler resultHandler,String format,String startDate, String endDate) {
        this.format = format;
        if (isValidDate(startDate, format) && isValidDate(endDate, format)) {
            canAccess = true;
            this.context = context;
...
//            window.setWindowAnimations(R.style.DialogAnimation);
    ...
    public void setSelectedTime(String time) {
        if (canAccess) {
            ...
            if(dateStr.length == 1){
                this.year_text.setVisibility(View.GONE);
                this.month_pv.setVisibility(View.GONE);
                this.month_text.setVisibility(View.GONE);
                this.day_pv.setVisibility(View.GONE);
                this.day_text.setVisibility(View.GONE);
                hour_pv.setVisibility(View.GONE);
                hour_text.setVisibility(View.GONE);
                minute_pv.setVisibility(View.GONE);
                minute_text.setVisibility(View.GONE);
