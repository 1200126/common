...
import myzxing.camera.open.OpenCameraInterface;
...
public final class CameraManager {
	...
	public CameraManager(Context context, SurfaceView surfaceView) {
		...
		this.configManager = new CameraConfigurationManager(context, surfaceView);
	...
	public synchronized void requestPreviewFrame(Handler handler, int message) {
		Camera theCamera = camera;
//		MUtils.log("requestPreviewFrame>>"+(theCamera != null && previewing));
		if (theCamera != null && previewing) {
...
//			int width = (int) (screenResolution.x * 0.8);
//			int height = width;
//
...
//			Log.d(TAG, "Calculated framing rect: " + framingRect);
	...
	public void setCameraZoomMax() {
		if (camera != null && camera.getParameters().isZoomSupported()) {
			Camera.Parameters parameters = camera.getParameters();
			parameters.setZoom(camera.getParameters().getMaxZoom());
			camera.setParameters(parameters);
